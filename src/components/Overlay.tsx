      ...
      >
        <div className="max-w-full sm:max-w-[600px] md:max-w-[760px] lg:max-w-[920px]">
          ...
          <div className="mt-2 sm:mt-3 text-lg sm:text-2xl md:text-4xl lg:text-5xl font-bold text-white flex items-baseline gap-2 sm:gap-3 whitespace-nowrap min-h-[40px] sm:min-h-[56px] relative">
            ...
            <div className="relative overflow-visible flex items-center whitespace-nowrap">
              <AnimatePresence mode="wait">
                <motion.span
                  key={roleIndex}
                  initial={{ x: 45, opacity: 0, scale: 0.92, filter: "blur(6px)" }}
                  animate={{ x: 0, opacity: 1, scale: 1, filter: "blur(0px)" }}
                  exit={{ x: -45, opacity: 0, scale: 0.92, filter: "blur(6px)" }}
                  transition={{
                    type: "spring",
                    stiffness: 320,
                    damping: 22,
                  ...
                  className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-amber-400 to-yellow-400 font-black inline-block whitespace-nowrap leading-tight py-1 drop-shadow-[0_4px_20px_rgba(251,146,60,0.45)] drop-shadow-[0_2px_10px_rgba(0,0,0,0.95)]"
                >
                  {roles[roleIndex]}
                </motion.span>
              </AnimatePresence>
          ...
          <div className="mt-6 sm:mt-8 flex flex-col items-start gap-2">
            ...
            <div className="w-[18px] h-[30px] rounded-full border border-white/20 p-1 flex justify-center backdrop-blur-sm bg-black/20">
              <motion.div
                animate={{ y: [0, 10, 0] }}
